...
hrb %>% 
  ...
  labs(title = "Average daily ridership, per hour, per bouroughs, across fare groups") +
...
# show just Times square
times_square <- "Times Sq-42 St (N,Q,R,W,S,1,2,3,7)/42 St (A,C,E)"
plots[[which(sta_mapgl$station_complex == times_square)]]
```
